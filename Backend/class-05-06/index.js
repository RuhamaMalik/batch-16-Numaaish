...
app.get('/v1/faq', (req, res) => {
  res.render('faq', { content: `<p>Moasam acha hai! --- version 1</p>` })
})

app.get('/v2/faq', (req, res) => {
  res.render('faq', { content: `<p>Moasam acha hai! --- version 2</p>` })
})


app.listen(8000, () => console.log('Server is Runnng on port 8000'));
